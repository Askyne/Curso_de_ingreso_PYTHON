...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        sueldo_actualizado = sueldo_usuario + sueldo_usuario * (15/100)

        frase_deseada = "El importe de su sueldo actualizado es de " + str(sueldo_actualizado) + "$"
        alert("Sueldo actualizado", frase_deseada)
