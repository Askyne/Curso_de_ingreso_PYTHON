...
3.	Para el departamento de logística:
    ...
    necesitamos que el programa informe cual es el tiempo (en horas) que tardará cada uno de los camiones, si sabemos que cada camión puede ir a una velocidad máxima
      y constante de 90 km/h  
...
class App(customtkinter.CTk):
    ...
    def btn_cantidad_camiones_on_click(self):
        ...
        cantidad_de_camiones_necesarios = math.ceil(toneladas/9500)
        alert("Cantidad de camiones", f"Se necesitan {cantidad_de_camiones_necesarios} camion/es")

    def btn_tiempo_llegada_on_click(self):
        kilometros= int(self.txt_kilometros.get())
        llegada_tiempo = kilometros / 90
        alert("Tiempo de llegada", f"Cada camion tardará un/unas {llegada_tiempo} hora/as en llegar")
